...
public class DecoratedBarcodeView extends FrameLayout {
    ...
    private void initialize(AttributeSet attrs) {
        ...
        printHand = findViewById(R.id.img_print_hand);
    ...
    public void refresh(){
        statusView.setText(getResources().getString(R.string.zxing_msg_default_status));
        statusView.setBackgroundColor(getResources().getColor(R.color.zxing_gray));
    }
